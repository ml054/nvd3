...
nv.models.timeline = function() {
  ...
  var margin       = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , getX         = function(d) { return d.start } // accessor to get the x value
  ...
  function chart(selection) {
    ...
    points.enter().append('line')
        ...
        .attr('x2', function (d, i) {
            var x2 = nv.utils.NaNtoZero(x0(getX(d, i) + getSize(d, i)));
            var x1 = nv.utils.NaNtoZero(x0(getX(d, i)));
            return minWidth < (x2 - x1) ? x2 : x1 + minWidth;
        })
